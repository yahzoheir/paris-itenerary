...
export default function GenerateWithCompassModal({
    ...
    // Identify custom selected items that are NOT in the available list
                ...
                <div className="p-6 border-b border-zinc-100 flex-shrink-0 flex justify-between items-start">
                    <div>
                        <h2 className="text-xl font-bold text-zinc-900">
                            {step === "chat" ? "Compass Chat" : "Plan your day with Compass"}
                        </h2>
                        <p className="text-sm text-zinc-500 mt-1">
                            {step === "chat"
                                ? "Describe what you want. Compass will draft a plan you can edit."
